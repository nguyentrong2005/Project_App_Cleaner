...
def build_settings_view(main_content):
    ...
    ctk.CTkLabel(f, text="⚙️ Cài đặt ứng dụng", font=(
    ...
    lang_menu = ctk.CTkOptionMenu(
        container, values=["Tiếng Việt", "English"], command=change_language)
    ...
    def toggle_sound():
        messagebox.showinfo(
            "Âm thanh", f"{'Đã bật' if sound_state.get() else 'Đã tắt'} âm thanh")
