...
def build_clean_view(main_content):
    ...
    ctk.CTkLabel(f, text="🧹 Dọn hệ thống", font=("Segoe UI", 22, "bold")).pack(pady=(20, 10))
    ctk.CTkLabel(f, text="Danh sách các mục rác được phát hiện:", font=("Segoe UI", 14)).pack(pady=(0, 10))
    ...
    ctk.CTkButton(f, text="⚡ Bắt đầu dọn", command=do_cleanup, fg_color="#10b981").pack(pady=15)
